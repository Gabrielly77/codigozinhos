...
<!doctype html>
  <html>
    <head>
      <title>Gabizinha Programadora</title>
      <link href="css/style.css" rel="stylesheet">
    </head>

    <body>        
      <h1>Mulheres Fodas Da Tecnologia!!!</h1>
      <nav class="principal">
        <ul>
          <li>
  ...
  <h4 class="titulo-branco">Quer saber mais sobre outras mulheres que fizeram história na programação? Deixe seu e-mail!</h4>
      <form>
